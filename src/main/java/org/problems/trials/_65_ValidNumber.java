...
public class _65_ValidNumber {
    public static void main(String[] args) {
        ...
        String s4 = "-123.456e789";
        System.out.println(s4 + ": " + isNumber(s4));

        String s5 = "-1a";
        System.out.println(s5 + ": " + isNumber(s5));
        String s6 = "1e";
        System.out.println(s6 + ": " + isNumber(s6));
        String s7 = "e3";
        System.out.println(s7 + ": " + isNumber(s7));
        String s8 = "99e2.5";
        System.out.println(s8 + ": " + isNumber(s8));
        String s9 = "--6";
        System.out.println(s9 + ": " + isNumber(s9));
    }
